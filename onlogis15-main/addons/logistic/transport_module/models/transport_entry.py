...
class transport_entry(models.Model):
    ...
    operation_id = fields.Many2one("freight.operation", "Freight Operation", read_only=True)
    ...
    state = fields.Selection(
        [('draft', 'Start'), ('waiting', 'Waiting'), ('in-progress', 'In-Progress'), ('done', 'Done'),
         ('cancel', 'Cancel'),
    ...
    user_id = fields.Many2one('res.users', string='Responsible User', index=True, track_visibility='onchange',
